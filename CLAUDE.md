...
- **⚠️ ただし公開は自動ではない（2026-09-26 判明）**: Play Console で「公開の管理」がオンだったため、審査通過後も「**変更を公開**」を押すまで配信されない。1.0.34〜1.0.48 は一度も公開されず、**Android ユーザーは全員 1.0.31 のままだった**（エントリー招待が Android の人に届かない原因にもなっていた）。9/26 に 1.0.49 を手動公開して解消
